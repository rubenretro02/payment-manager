...
export interface EvmTokenDef {
  ...
  decimals: number;
  /**
   * Circle's native USDC (FiatToken v2+) supports EIP-3009
   * transferWithAuthorization: the holder signs off-chain and a relayer (our
   * gas tank) submits and pays the fee — the holder needs no ETH at all.
   * Verified again on-chain (version()) before use.
   */
  eip3009?: boolean;
}
...
export const EVM_CHAINS: EvmChainDef[] = [
  {
    ...
    tokens: [
      { symbol: 'USDC', address: '0xa0b86991c6218b36c1d19d4a2e9eb0ce3606eb48', decimals: 6, eip3009: true },
  ...
  },
  {
    ...
    tokens: [
      { symbol: 'USDC', address: '0x833589fcd6edb6e08f4c7c32d4f71b54bda02913', decimals: 6, eip3009: true },
  ...
  },
  {
    ...
    tokens: [
      { symbol: 'USDC', address: '0xaf88d065e77c8cc2239327c5edb3a432268e5831', decimals: 6, eip3009: true },
  ...
  },
  {
    ...
    tokens: [
      { symbol: 'USDC', address: '0x0b2c639c533813f4aa9d7837caf62653d097ff85', decimals: 6, eip3009: true },
  ...
  },
  {
    ...
    tokens: [
      { symbol: 'USDC', address: '0x3c499c542cef5e3811e1192ce70d8cc03d5c3359', decimals: 6, eip3009: true },
  ...
  },
  {
    ...
    tokens: [
      { symbol: 'USDC', address: '0x1d17cbcf0d6d143135ae902365d2e5e2a16538d4', decimals: 6, eip3009: true },
